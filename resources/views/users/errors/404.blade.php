...
<!-- demo/page-404-style1.html  [XR&CO'2014], Wed, 03 Feb 2021 11:23:41 GMT -->
<head>
                    ...
                    <div class="container pt-0 pb-0">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <h2 class="mt-0">{{ __('error.page_not_found') }}</h2>
                                <a class="btn btn-border btn-gray btn-transparent btn-circled smooth-scroll-to-target" href="{{ url('') }}">{{ __('app_info.home') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                    <p class="mb-0">Copyright &copy;2021 ThemeMascot. All Rights Reserved</p>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </footer>--}}
