<x-user-layout>
                ...
                <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                    <ul>
                        ...
                        <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg12.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="images/bg/bg12.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                            ...
                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                 ...
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Take the <span class="text-theme-colored">world's</span> best <span class="text-theme-color-2">Quality</span> Treatmen.
                            </div>
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                 id="slide-1-layer-3"
                            ...
                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                 ...
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 style="z-index: 7; white-space: nowrap;"><a href="#" class="btn btn-dark btn-theme-colored btn-xl">Read More</a> <a href="#" class="btn btn-dark btn-theme-colored btn-xl">Register Now</a>
                            </div>
                        </li>

                        <!-- SLIDE 2 -->
                        <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg14.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="images/bg/bg14.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0"
                                 id="slide-2-layer-1"
                        ...
                        <!-- SLIDE 3 -->
                        <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg13.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="images/bg/bg13.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0"
                                 id="slide-3-layer-1"
                ...
                <div class="row equal-height-inner mt-sm-0" data-margin-top="-110px">
                    <div class="col-sm-12 col-md-3 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
                        <div class="sm-height-auto bg-theme-colored">
                            <div class="p-30">
                                <h3 class="text-uppercase text-white mt-0">Top Doctors <br><small class="text-gray-lighter">Care Solutions</small></h3>
                    ...
                    <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay4">
                        <div class="sm-height-auto bg-theme-colored2">
                            <div class="p-30">
                                <h3 class="text-uppercase text-white mt-0">Booking A Visit <br><small class="text-gray-lighter">Close To Home</small></h3>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="twentytwenty-container">
                            <img src="images/before-after/1.jpg" alt="">
                            <img src="images/before-after/2.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        ...
                        <ul class="list-inline mt-30">
                            <li><img src="images/awards/1.png" alt="" width="80"></li>
                            <li><img src="images/awards/2.png" alt="" width="80"></li>
                            <li><img src="images/awards/3.png" alt="" width="80"></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel-4col">
                        <div class="item">
                            <a href="images/certificates/b1.jpg" data-lightbox-gallery="certificates" title="Certificate"><img src="images/certificates/s1.jpg" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="images/certificates/b2.jpg" data-lightbox-gallery="certificates" title="Certificate"><img src="images/certificates/s2.jpg" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="images/certificates/b3.jpg" data-lightbox-gallery="certificates" title="Certificate"><img src="images/certificates/s3.jpg" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="images/certificates/b4.jpg" data-lightbox-gallery="certificates" title="Certificate"><img src="images/certificates/s4.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="flaticon-medical-teeth2 text-white"></i></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="fa fa-medkit text-white"></i></a>
                            <div class="media-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="flaticon-medical-brush18 text-white"></i></a>
                            <div class="media-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="flaticon-medical-medical51 text-white"></i></a>
                            <div class="media-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="flaticon-medical-dentist text-white"></i></a>
                            <div class="media-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="icon-box iconbox-theme-colored2 left media p-0">
                            <a href="#" class="icon bg-theme-colored icon-circled media-left pull-left"><i class="flaticon-medical-hospital35 text-white"></i></a>
                            <div class="media-body">
    ...
    <!-- Divider: Funfact -->
    <section class="divider parallax layer-overlay overlay-theme-colored-8" data-bg-img="images/bg/bg5.jpg" data-parallax-ratio="0.7">
        <div class="container">
            <div class="row">
    ...
    <section  class="divider parallax layer-overlay overlay-theme-colored-8" data-bg-img="images/bg/bg6.jpg">
        <div class="container">
    ...
    <section class="divider parallax layer-overlay overlay-theme-colored-8" data-parallax-ratio="0.1" data-bg-img="images/bg/bg6.jpg">
        <div class="container">
            <div class="section-title text-center">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="owl-carousel-3col" data-dots="true">
                            <div class="item">
                                <div class="testimonial style1">
                                    ...
                                    <div class="content mt-20">
                                        <div class="thumb pull-right flip"> <img class="img-circle" alt="" src="images/testimonials/1.png"> </div>
                            ...
                            <div class="item">
                                <div class="testimonial style1">
                                    ...
                                    <div class="content mt-20">
                                        <div class="thumb pull-right flip"> <img class="img-circle" alt="" src="images/testimonials/2.png"> </div>
                                        <div class="text-right flip pull-right flip mr-20 mt-10">
                            ...
                            <div class="item">
                                <div class="testimonial style1">
                                    ...
                                    <div class="content mt-20">
                                        <div class="thumb pull-right flip"> <img class="img-circle" alt="" src="images/testimonials/3.png"> </div>
                                        <div class="text-right flip pull-right flip mr-20 mt-10">
                            ...
                            <div class="item">
                                <div class="testimonial style1">
                                    ...
                                    <div class="content mt-20">
                                        <div class="thumb pull-right flip"> <img class="img-circle" alt="" src="images/testimonials/1.jpg"> </div>
                                        <div class="text-right flip pull-right flip mr-20 mt-10">
                    ...
                    <div class="owl-carousel-3col owl-nav-top mb-sm-0" data-nav="true">
                            ...
                            <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="images/blog/16.jpg" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="images/blog/17.jpg" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>
                                <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                                    <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
                        ...
                        <div class="item">
                            <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="images/blog/18.jpg" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>
                                <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                                    <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
                        ...
                        <div class="item">
                            <article class="post clearfix maxwidth600 mb-30 wow fadeInRight" data-wow-delay=".2s">
                                <div class="entry-header">
                                    <div class="post-thumb thumb">
                                        <img src="images/blog/19.jpg" alt="" class="img-responsive img-fullwidth">
                                    </div>
                                </div>
                                <div class="bg-theme-colored2 p-5 text-center pt-10 pb-10">
                                    <span class="mb-10 text-white mr-10 font-13"><i class="fa fa-calendar mr-5 text-white"></i>21 February</span>
